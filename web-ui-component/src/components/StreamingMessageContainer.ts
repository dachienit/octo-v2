...
export class StreamingMessageContainer extends LitElement {
	@property({ type: Array }) declare tools: AgentTool[];
	@property({ type: Boolean }) declare isStreaming: boolean;
	@property({ type: Object }) declare pendingToolCalls: Set<string> | undefined;
	@property({ type: Object }) declare toolResultsById: Map<string, ToolResultMessage> | undefined;
	@property({ attribute: false }) declare onCostClick: (() => void) | undefined;

	@state() private declare _message: AgentMessage | null;
	...
	constructor() {
		...
		this.toolResultsById = undefined;
		this.onCostClick = undefined;
		this._message = null;
	}
