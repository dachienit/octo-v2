...
export class ProviderKeyInput extends LitElement {
	@property() declare provider: string;
	@state() private declare keyInput: string;
	@state() private declare testing: boolean;
	@state() private declare failed: boolean;
	@state() private declare hasKey: boolean;
	@state() private declare inputChanged: boolean;
